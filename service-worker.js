const CACHE='smart-store-v1-20260904-customer-cache-fix-1';
const ASSETS=['./','index.html','admin.html','styles.css','app.js?v=20260904-3','admin.js','admin-approval.js','push-client.js?v=20260904-3','cloud-config.js','manifest.json','admin-manifest.json'];
