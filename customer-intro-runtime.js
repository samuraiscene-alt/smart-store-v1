...
(() => {
  ...
  function addStyles(){
    ...
    style.textContent = `
      ...
      @keyframes customerIntroFade{0%{opacity:0}100%{opacity:1}}
      @keyframes customerIntroFadeInOut{0%,100%{opacity:0}25%,75%{opacity:1}}
      @keyframes customerIntroSlideLeft{0%{opacity:0;transform:translate(-65%,-50%)}100%{opacity:1;transform:translate(-50%,-50%)}}
      @keyframes customerIntroSlideRight{0%{opacity:0;transform:translate(-35%,-50%)}100%{opacity:1;transform:translate(-50%,-50%)}}
      @keyframes customerIntroSlideUp{0%{opacity:0;transform:translate(-50%,-30%)}100%{opacity:1;transform:translate(-50%,-50%)}}
      @keyframes customerIntroZoom{0%{opacity:0;transform:translate(-50%,-50%) scale(.86)}100%{opacity:1;transform:translate(-50%,-50%) scale(1)}}
    `;
  ...
  async function fetchStore(){
    ...
    if(!window.supabase?.createClient || !CONFIG.supabaseUrl || !CONFIG.supabaseKey || !CONFIG.storeSlug) return null;
  ...
  async function customerSetupIntro(){
    ...
    cfg.texts.forEach(t=>{
      ...
      if(t.animation !== 'none'){
        el.style.animation = `${animationNames[t.animation]} ${t.duration}s ease ${t.delay}s both`;
      }
