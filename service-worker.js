const CACHE='smart-store-v1-20260904-customer-push-detail-1';
const ASSETS=['./','index.html','admin.html','styles.css','app.js?v=20260904-4','admin.js','admin-approval.js','push-client.js?v=20260904-4','customer-reservation.js?v=20260904-1','cloud-config.js','manifest.json','admin-manifest.json'];
